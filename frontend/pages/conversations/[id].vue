...
function shouldShowModelSwitchIndicator(idx: number): boolean {
  ...
  // JCLAW-1222: routed turns change model by design, and each names its own route below.
          ...
          <div :class="msg.role === 'user' ? 'ml-16' : msg.role === 'tool' ? 'ml-8' : ''">
            <div class="flex items-center gap-2 mb-0.5">
              ...
              <span
                ...
                :title="msg.usage.route ? routeDescription(msg.usage.route) : `Generated by ${formatModelLabel(msg)}`"
              >
