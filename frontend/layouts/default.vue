      ...
      <div class="h-14 flex items-center justify-between px-3 border-b border-neutral-200 dark:border-neutral-800 shrink-0">
        <div class="flex items-center gap-2.5">
          ...
          <div class="leading-tight">
            ...
            <div class="text-sm font-semibold" aria-label="JClaw"><span class="text-emerald-700 dark:text-emerald-400" aria-hidden="true">J</span><span class="text-red-600 dark:text-red-500" aria-hidden="true">Claw</span></div>
          </div>
        </div>
        <button
