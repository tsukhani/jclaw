...
<template>
  ...
  >
    ...
    >
      <!-- Resize handle uses ARIA separator role because there is no native HTML element for a resizable divider; this is the WAI ARIA recommended role for that pattern. -->
