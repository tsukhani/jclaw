...
<template>
  <div role="search" class="flex items-center gap-2 flex-wrap">
    <!-- Chips + input -->
      ...
      >
        ...
        <div class="border-t border-border">
          <div v-if="showSaveInput" class="flex items-center gap-1 px-2 py-1.5">
            ...
            />
            <button @click="saveCurrentView" class="text-xs text-emerald-600 dark:text-emerald-400 hover:underline">Save</button>
          </div>
          <button
            v-else
