...
function setupApi(opts?: { capturePost?: (b: { key?: string, value?: string }) => void, videoFrames?: string, models?: string }) {
...
describe('Settings page — Video Interpretation (JCLAW-223)', () => {
  ...
  it('shows Tier 1 when the default model supports native video', async () => {
