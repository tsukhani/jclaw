---
name: git
description: Git commits, branches, rebases, merges, conflict resolution, history recovery, team workflows, and safe day-to-day version control.
version: 1.0.0
author: clawhub.ai/git
tools: [exec]
commands: []
icon: 📚
---
