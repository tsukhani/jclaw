...
> Master index — primary AI retrieval entry point. Generated by `bmad-document-project` on **2026-06-29** via deep rescan; selected facts (version pins, memory subsystem, `/api/memories`, license) surgically corrected **2026-07-14** without a full regenerate.
>
...
- **Version:** `0.16.19` (status: pre-v1 / alpha per CLAUDE.md).
