...
- Hand-authored architecture notes alongside the generated set: [`jclaw-agentic-refactor.md`](jclaw-agentic-refactor.md) (refactor plan) and [`adr/ADR-001-defer-redis.md`](adr/ADR-001-defer-redis.md). These are **not** regenerated by this workflow.
